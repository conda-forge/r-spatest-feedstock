...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4659&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-spatest-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-spatest` can be installed with `conda`:
...
```
mamba install r-spatest
```

It is possible to list all of the versions of `r-spatest` available on your platform with `conda`:
...
```
mamba search r-spatest --channel conda-forge
```
...
mamba repoquery search r-spatest --channel conda-forge

# List packages depending on `r-spatest`:
mamba repoquery whoneeds r-spatest --channel conda-forge

# List dependencies of `r-spatest`:
mamba repoquery depends r-spatest --channel conda-forge
```
...
* [@endrebak](https://github.com/endrebak/)
